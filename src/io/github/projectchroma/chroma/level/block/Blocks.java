...
public class Blocks{
	...
	public static Block createBlock(String color, float x, float y, float width, float height, Color scheme){
		if(classByColor.containsKey(color)){
			try{
				...
				throw new IllegalArgumentException("Error creating block of color " + color, ex);
			}
